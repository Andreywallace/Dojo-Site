...
function hideAceleradas(toggle)
{
    if(isMobile===false)
    {
...
function showAceleradas(toggle)
{
    if(isMobile===false)
    {
        var thisContent=toggle.getElementsByClassName('js-aceleradas-content')[0];
        var documentContent=document.getElementsByClassName("js-aceleradas-content");
        thisContent.classList.toggle('state-active');
        for(var i=0;i<documentContent.length;i++)
        {
            if(documentContent[i]!==thisContent)
            {
                documentContent[i].classList.remove('state-active');
            }
        }
    }
}
